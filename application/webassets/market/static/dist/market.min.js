...
return selections}
function showResults(val){let res=document.getElementById("result");res.innerHTML='';if(ss.length<=5){res.appendChild(build_selections(ss))}else{let terms=autocompleteMatch(val)
